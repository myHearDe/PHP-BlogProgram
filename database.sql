...
-- 注意：根据用户配置，现在使用现有的test_9zcnb_com数据库
-- 请确保该数据库已存在，并且您有足够的权限
-- 如果需要创建数据库，请取消下面这行的注释
-- CREATE DATABASE IF NOT EXISTS test_9zcnb_com CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

-- 切换到用户的数据库
-- 当前使用的数据库：test_9zcnb_com
USE test_9zcnb_com;
